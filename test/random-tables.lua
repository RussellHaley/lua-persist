...
return setmetatable(
        ...
        , {
                __call  = function( self, max )
                        local rtvg =  {
                                max  = max or 10000000,
                                keys = { m.getTable, m.getWords, m.getBoolean, m.getFloat}, --, m.getFunction, m.getCoroutine },
                                vals = { m.getTable, m.getWords, m.getBoolean, m.getFloat} --, m.getInteger, m.getFunction, m.getCoroutine }
                        }
