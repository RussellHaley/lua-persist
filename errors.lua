...
local errors = {
  ...
  COMMIT_NOT_A_TRACKER_TABLE = {errno=3,err="You did not use a tracker table and called commit. Use one of <db>:[add_item(s)|del_item(s)|upsert] instead."},
  ...
  NIL_VALUE = {errno=9, err="A nil was passed as an argument expecting a value."}
}
